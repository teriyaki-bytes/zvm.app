...
This is **zvm.app** - the official documentation website for the Zig Version Manager (ZVM). The content is based on the README from https://github.com/tristanisham/zvm. Built with Astro and Starlight documentation framework.
...
- `src/content/docs/reference/` - Command reference and how-to guides (auto-generated in sidebar)
...
**Key Behaviors:**
- The "How To" sidebar section auto-generates from files in `reference/` directory
